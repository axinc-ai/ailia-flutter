...
class ailiaAudioFFI {
  ...
  ailiaAudioFFI(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ailiaAudioFFI.fromLookup(
  ...
  late final _ailiaAudioConvertPowerToDBPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
              ffi.Int32, ffi.Float)>>('ailiaAudioConvertPowerToDB');
  ...
  late final _ailiaAudioGetFrameLenPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Int32>, ffi.Int32, ffi.Int32,
              ffi.Int32, ffi.Int32)>>('ailiaAudioGetFrameLen');
  late final _ailiaAudioGetFrameLen = _ailiaAudioGetFrameLenPtr
      .asFunction<int Function(ffi.Pointer<ffi.Int32>, int, int, int, int)>();
  ...
  int ailiaAudioGetSampleLen(
    ffi.Pointer<ffi.Int32> sample_n,
    int frame_n,
    int freq_n,
    int hop_n,
    int center,
  ...
  late final _ailiaAudioGetSampleLenPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Int32>, ffi.Int32, ffi.Int32,
              ffi.Int32, ffi.Int32)>>('ailiaAudioGetSampleLen');
  ...
  late final _ailiaAudioGetSpectrogramPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Float,
              ffi.Int32)>>('ailiaAudioGetSpectrogram');
  ...
  late final _ailiaAudioGetInverseSpectrogramPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ailiaAudioGetInverseSpectrogram');
  ...
  late final _ailiaAudioGetFBMatrixPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ailiaAudioGetFBMatrix');
  ...
  late final _ailiaAudioGetMelSpectrogramPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ailiaAudioGetMelSpectrogram');
  ...
  late final _ailiaAudioStandardizePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
              ffi.Int32)>>('ailiaAudioStandardize');
  ...
  late final _ailiaAudioComplexNormPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
              ffi.Int32, ffi.Float)>>('ailiaAudioComplexNorm');
  ...
  late final _ailiaAudioConvertToMelPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ailiaAudioConvertToMel');
  ...
  late final _ailiaAudioFixFrameLenPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Float)>>('ailiaAudioFixFrameLen');
  ...
  int ailiaAudioGetResampleLen(
    ffi.Pointer<ffi.Int32> dst_sample_n,
    int dst_sample_rate,
    int src_sample_n,
    int src_sample_rate,
  ) {
  ...
  late final _ailiaAudioGetResampleLenPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Int32>, ffi.Int32, ffi.Int32,
              ffi.Int32)>>('ailiaAudioGetResampleLen');
  ...
  late final _ailiaAudioLinerFilterPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ailiaAudioLinerFilter');
  ...
  late final _ailiaAudioGetLinerFilterZiCoefPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ailiaAudioGetLinerFilterZiCoef');
  ...
  late final _ailiaAudioFilterFilterPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ailiaAudioFilterFilter');
  ...
  int ailiaAudioGetNonSilentPos(
    ffi.Pointer<ffi.Int32> dst_start_pos,
    ffi.Pointer<ffi.Int32> dst_length,
    ffi.Pointer<ffi.Void> src,
    int sample_n,
    int win_n,
    int hop_n,
